# ImFhired — TestSprite Test Suite

## App URL
http://localhost:3002

## Test Accounts
- Candidate: testcandidate@imfhired.com / Test1234!
- Recruiter: testrecruiter@imfhired.com / Test1234!

---

## TEST 1: Landing Page Loads
Navigate to http://localhost:3002
Verify the page title contains "ImFhired"
...
Navigate to http://localhost:3002/auth/register
Click the button with text "Job Seeker"
Fill the input with type "email" with value "testcandidate@imfhired.com"
Fill the input with placeholder "Min 8 chars, include a number" with value "Test1234!"
...
Fill the input with type "email" with value "testrecruiter@imfhired.com"
Fill the input with type "password" with value "Test1234!"
Click the button with text "Sign In"
...
## TEST 8: Post a Job
Navigate to http://localhost:3002/auth/login
Login as testrecruiter@imfhired.com with Test1234!
...
Navigate to http://localhost:3002/auth/login
Login as testcandidate@imfhired.com with Test1234!
...
Fill the email input with value "testcandidate@imfhired.com"
